...
class LessonFragment(private val lessons: String, private val lessonsTitle: Lessons) : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.setLessons(lessons, lessonsTitle.name)
...
//        viewModel.mLessonTitle.observe(viewLifecycleOwner) { lessonsTitle ->
//
//
//        }
    }
